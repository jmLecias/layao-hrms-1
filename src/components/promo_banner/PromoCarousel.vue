  ...
  >
    <div class="relative w-full max-w-5xl mx-auto rounded-2xl overflow-hidden">
      ...
      <div class="relative h-[700px]">
        ...
        <!-- <div class="absolute inset-0 flex flex-col justify-end to-transparent p-10">
      ...
      <button
        @click="closePromo"
        class="absolute top-5 right-5 w-10 h-10 flex cursor-pointer items-center justify-center rounded-full bg-white/90 text-gray-800 hover:bg-white hover:shadow transition"
      >
